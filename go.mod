...
require github.com/openshift-kni/eco-goinfra v0.0.0-20231120223445-2dc7848610c7
...
require (
	...
	github.com/rh-ecosystem-edge/kernel-module-management v0.0.0-20230727220418-baf359495376 // indirect
