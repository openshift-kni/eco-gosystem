...
import (
	...
	_ "github.com/openshift-kni/eco-gosystem/tests/ranfunc/powermanagement/tests"
)
...
var _ = BeforeSuite(func() {
	...
	namespace := namespace.NewBuilder(ranfuncinittools.HubAPIClient, powermanagementparams.NamespaceTesting)
	if namespace.Exists() {
